...
/**
 * code-style-all-in-one story decorator: keeps the manager theme in sync and reloads the iframe
 * when the locale toolbar is toggled, so docs/stories pick up the new language without stale
 * i18next state.
 */
